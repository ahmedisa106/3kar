...
@section('content')
    ...
    <div class="property_details_banner">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-8 col-lg-6">
                    <div class="comfortable_apartment">
                        <h4>{{$buInfo->name}}</h4>
                        <p><img src="{{asset('/')}}design/realestate/img/svg_icon/location.svg"
                                alt=""> {{$buInfo->place}}</p>
                        <div class="quality_quantity d-flex">
                            <div class="single_quantity">
                                <img src="{{asset('/')}}design/realestate/img/svg_icon/color_box.svg" alt="">
                                <span>{{$buInfo->square}} Sqft</span>
                            </div>
                            <div class="single_quantity">
                                <img src="{{asset('/')}}design/realestate/img/svg_icon/color_bed.svg" alt="">
                                <span>{{$buInfo->rooms}} Bed</span>
                            </div>
                            <div class="single_quantity">
                                <img src="{{asset('/')}}design/realestate/img/svg_icon/color_bath.svg" alt="">
                                <span>2 Bath</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-right">
                <div class="addthis_inline_share_toolbox text-right">
                    ...
                    <div class="property_banner">
                        <div class="property_banner_active owl-carousel">
                            <div class="single_property">
                                <img src="{{asset('/')}}website/Bu_images/{{$buInfo->image}}" style="max-height: 580px;"
                                     alt="">
                            </div>
                            <div class="single_property">
                                <img src="{{asset('/')}}website/Bu_images/{{$buInfo->image}}" style="max-height: 580px;"
    ...
    <div class="popular_property plus_padding">
        <div class="container">
            <div class="row">
                @if($same->count()>0)
                    <h4 class="container">Similar Buildings : </h4>
                    <hr>
                    @foreach($same as $bu)
    ...
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5e962265d04d08f1"></script>
